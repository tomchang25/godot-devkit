...
Do not use this for small features or narrow refactors. Use the consumer's compact implementation note or standalone implementation spec as appropriate.
