...
Reporting language: follow `dev/workflows/review_standard.md`. Keep required verdict labels (`pass`, `needs changes`, `blocked`) and conventional PR title syntax in English.
